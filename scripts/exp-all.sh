...
echo "./exp-genplots-GPU.sh ../data/TITAN-RTX-ARCHsm_75 "NVIDIA TITAN RTX"               16 16    64  8  64  8  16 16  64  4     72 64    $((2**16))    2 2 4    0 16"
./exp-genplots-GPU.sh ../data/TITAN-RTX-ARCHsm_75 "NVIDIA TITAN RTX"               16 16    64  8  64  8  16 16  64  4     72 64    $((2**16))    2 2 4    0 16
