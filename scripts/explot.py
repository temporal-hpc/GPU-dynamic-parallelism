...
ax.plot(df_DPSBR[VAR], DPSBR_FUNC, Q.dStyle[iVAR][3], lw=1, markersize=3, label=dFuncText[iVAR]('DP-SBR'+ftext_DPSBR),color=Q.cGreen[1],alpha=Q.alpha_grB[iVAR])
ax.plot(df_DPMBR[VAR], DPMBR_FUNC, Q.dStyle[iVAR][4], lw=1, markersize=3, label=dFuncText[iVAR]('DP-MBR'+ftext_DPMBR),color=Q.cPurple[0],alpha=Q.alpha_grB[iVAR])
ax.plot(df_ASKSBR[VAR], ASKSBR_FUNC, Q.dStyle[iVAR][1],lw=1,markersize=3,label=dFuncText[iVAR]('ASK-SBR'+ftext_ASKSBR),color=Q.cTemporal[0],alpha=Q.alpha_grB[iVAR])
ax.plot(df_ASKMBR[VAR], ASKMBR_FUNC, Q.dStyle[iVAR][2], lw=1, markersize=3,label=dFuncText[iVAR]('ASK-MBR'+ftext_ASKMBR),color=Q.cRed[0],alpha=Q.alpha_grB[iVAR])
